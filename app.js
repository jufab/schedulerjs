...
app.use('/js', express.static(path.join(__dirname + '/node_modules/materialize-css/dist/js'))); // redirect materialize JS
...
app.use('/fonts', express.static(path.join(__dirname + '/node_modules/materialize-css/dist/fonts')));
